                                	...
                                	<select name="parent.id" class="form-control">
                                		<#list list as r>
                                			<#if r.parent==null>
	                                			...
	                                			<#list list as twor>
	                                					<#if twor.parent?exists&&twor.parent.id==r.id>
	                                						<option value="${twor.id}" <#if resource.parent.id == twor.id>selected="selected"</#if>>
				                                				　|-${twor.name}
				                                			</option>
				                                			<#list list as threer>
				                                					<#if threer.parent?exists&&threer.parent.id==twor.id>
				                                							<option value="${threer.id}" <#if resource.parent.id == threer.id>selected="selected"</#if>>
								                                				　　|-${threer.name}
								                                			</option>
				                                					</#if>
				                                			</#list>
